...
export default function PredictiveSearch({ className }: { className?: string }) {
  ...
  return (
    <div ref={containerRef} className={`relative ${className ?? ""}`}>
      ...
      {open && (
        <div className="fixed inset-0 z-[90] flex flex-col bg-white sm:absolute sm:inset-x-0 sm:top-full sm:z-40 sm:mt-2 sm:block sm:max-h-[70vh] sm:overflow-hidden sm:rounded-2xl sm:border sm:border-slate-100 sm:shadow-[0_30px_60px_-20px_rgba(15,23,42,0.25)]">
